...
**Maturity:** Validated. PR 2.5.1 established the run-summary system; PR 2.5.2 added
...
recovery count. PR 2.5.2 adds only automatic safety-pause count and aggregate
